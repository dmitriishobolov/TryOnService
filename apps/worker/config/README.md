...
- `TSUM_PUBLIC_SEARCH_BASE_URL`, `TSUM_PUBLIC_PRODUCT_BASE_URL`, `TSUM_PUBLIC_SEARCH_PARAM_NAME`, `TSUM_PUBLIC_SEARCH_PAGES`, `TSUM_MAX_SCAN_PRODUCTS`, `TSUM_PRODUCT_URL_TEMPLATE`, `TSUM_PUBLIC_USER_AGENT`, `TSUM_PUBLIC_REQUEST_INTERVAL_MS` - настройки TSUM public parser. Adapter читает search/catalog HTML, JSON-LD `ItemList/Product`, ссылки `/product/...` и карточки товара.
- `TSUM_PUBLIC_CACHE_TTL_MS`, `TSUM_PUBLIC_CACHE_STALE_TTL_MS`, `TSUM_PUBLIC_CACHE_MAX_ENTRIES`, `TSUM_PUBLIC_ERROR_COOLDOWN_MS` - in-memory cache и cooldown TSUM parser-а.
- `TSUM_OUTLET_PUBLIC_SEARCH_BASE_URL`, `TSUM_OUTLET_PUBLIC_PRODUCT_BASE_URL`, `TSUM_OUTLET_PUBLIC_SEARCH_PARAM_NAME`, `TSUM_OUTLET_PUBLIC_SEARCH_PAGES`, `TSUM_OUTLET_MAX_SCAN_PRODUCTS`, `TSUM_OUTLET_PRODUCT_URL_TEMPLATE`, `TSUM_OUTLET_PUBLIC_USER_AGENT`, `TSUM_OUTLET_PUBLIC_REQUEST_INTERVAL_MS` - настройки TSUM Outlet public parser с отдельным поисковым base URL и отдельным cache/cooldown.
- `TSUM_OUTLET_PUBLIC_CACHE_TTL_MS`, `TSUM_OUTLET_PUBLIC_CACHE_STALE_TTL_MS`, `TSUM_OUTLET_PUBLIC_CACHE_MAX_ENTRIES`, `TSUM_OUTLET_PUBLIC_ERROR_COOLDOWN_MS` - in-memory cache и cooldown TSUM Outlet parser-а.
- `OSTIN_PUBLIC_SEARCH_BASE_URL`, `OSTIN_PUBLIC_PRODUCT_BASE_URL`, `OSTIN_PUBLIC_SEARCH_PARAM_NAME`, `OSTIN_PUBLIC_SEARCH_PAGES`, `OSTIN_MAX_SCAN_PRODUCTS`, `OSTIN_PRODUCT_URL_TEMPLATE`, `OSTIN_PUBLIC_USER_AGENT`, `OSTIN_PUBLIC_REQUEST_INTERVAL_MS` - настройки O'STIN public parser. Adapter поддерживает URL товаров `/product/<slug>/<id>` и корректно уходит в cooldown, если сайт вернул QRator/captcha/challenge.
- `OSTIN_PUBLIC_CACHE_TTL_MS`, `OSTIN_PUBLIC_CACHE_STALE_TTL_MS`, `OSTIN_PUBLIC_CACHE_MAX_ENTRIES`, `OSTIN_PUBLIC_ERROR_COOLDOWN_MS` - in-memory cache и cooldown O'STIN parser-а.
- `TWOMOOD_PUBLIC_SEARCH_BASE_URL`, `TWOMOOD_PUBLIC_PRODUCT_BASE_URL`, `TWOMOOD_PUBLIC_SEARCH_PARAM_NAME`, `TWOMOOD_PUBLIC_SEARCH_PAGES`, `TWOMOOD_MAX_SCAN_PRODUCTS`, `TWOMOOD_PRODUCT_URL_TEMPLATE`, `TWOMOOD_PUBLIC_USER_AGENT`, `TWOMOOD_PUBLIC_REQUEST_INTERVAL_MS` - настройки 2MOOD public parser. Adapter использует category routes сайта и поддерживает URL товаров `/collection/katalog/<slug>/`.
- `TWOMOOD_PUBLIC_CACHE_TTL_MS`, `TWOMOOD_PUBLIC_CACHE_STALE_TTL_MS`, `TWOMOOD_PUBLIC_CACHE_MAX_ENTRIES`, `TWOMOOD_PUBLIC_ERROR_COOLDOWN_MS` - in-memory cache и cooldown 2MOOD parser-а.
- `LIME_PUBLIC_SEARCH_BASE_URL`, `LIME_PUBLIC_PRODUCT_BASE_URL`, `LIME_PUBLIC_SEARCH_PARAM_NAME`, `LIME_PUBLIC_SEARCH_PAGES`, `LIME_MAX_SCAN_PRODUCTS`, `LIME_PRODUCT_URL_TEMPLATE`, `LIME_PUBLIC_USER_AGENT`, `LIME_PUBLIC_REQUEST_INTERVAL_MS` - настройки LIMÉ public parser. Adapter использует category routes `/ru_ru/catalog/...` и поддерживает URL товаров `/ru_ru/product/<id-slug>`.
- `LIME_PUBLIC_CACHE_TTL_MS`, `LIME_PUBLIC_CACHE_STALE_TTL_MS`, `LIME_PUBLIC_CACHE_MAX_ENTRIES`, `LIME_PUBLIC_ERROR_COOLDOWN_MS` - in-memory cache и cooldown LIMÉ parser-а.
