...
- Prompt-ы для поиска и проверки используют compact JSON, `imageDetail=low`, `reasoningEffort=minimal` и короткий validation-ответ `acceptedCandidates` с `canGenerateCleanCard`, чтобы снизить расход токенов.
