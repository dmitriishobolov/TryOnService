...
const services = [
  ...
  },
  {
    ...
    envKeys: [
      ...
      "TSUM_PUBLIC_SEARCH_PARAM_NAME",
      "TSUM_PUBLIC_SEARCH_PAGES",
      "TSUM_MAX_SCAN_PRODUCTS",
      ...
      "TSUM_OUTLET_PUBLIC_SEARCH_PAGES",
      "TSUM_OUTLET_MAX_SCAN_PRODUCTS",
      ...
      "OSTIN_PUBLIC_SEARCH_PAGES",
      "OSTIN_MAX_SCAN_PRODUCTS",
      ...
      "TWOMOOD_PUBLIC_SEARCH_PAGES",
      "TWOMOOD_MAX_SCAN_PRODUCTS",
      ...
      "LIME_PUBLIC_SEARCH_PAGES",
      "LIME_MAX_SCAN_PRODUCTS",
      ...
      "WILDBERRIES_PUBLIC_DEST",
      "WILDBERRIES_PUBLIC_SORT",
      "WILDBERRIES_PUBLIC_SPP",
