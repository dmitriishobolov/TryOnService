...
async function buildDevtestEnv() {
  ...
  return {
    ...
    CATALOG_INGESTOR_CUSTOM_SOURCE_FILE: merged.CATALOG_INGESTOR_CUSTOM_SOURCE_FILE?.trim() || "",
    CATALOG_INGESTOR_CUSTOM_URL: merged.CATALOG_INGESTOR_CUSTOM_URL?.trim() || "",
    CATALOG_INGESTOR_TSUM_START_URL:
      merged.CATALOG_INGESTOR_TSUM_START_URL?.trim() ||
