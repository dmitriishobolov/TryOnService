...
const categoryAliasesByCanonical: Record<string, string[]> = {
  ...
  "смокинг": ["tuxedo"],
  "носки": ["гольфы", "socks"],
  "нижнее белье": ["трусы", "трусы-шорты", "боксеры", "брифы", "слипы", "хипсы", "underwear", "boxers", "boxer shorts", "briefs", "panties", "knickers", "lingerie"],
...
const categoryInferenceRules: Array<[RegExp, string]> = [
  ...
  [/top|топ/, "топ"],
  [/plavk|swim trunks|swimwear|swim shorts|плавк|плавательн|пляжн|купальн/, "плавки"],
  [/boxer shorts|underwear|boxer|brief|panties|knickers|lingerie|боксер|бриф|хипс|трус|слип/, "нижнее белье"],
  [/short|шорт/, "шорты"],
  [/yubk|skirt|юбк/, "юбка"],
